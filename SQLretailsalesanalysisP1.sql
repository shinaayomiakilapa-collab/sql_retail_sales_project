...
--5 Write a sql query to find all transactions where thr total_sales is greater than 1000
...
--7 Write a sql query to calculate the average sale for each month. Find out best selling month in eeach year
...
SELECT
	category,
	COUNT(DISTINCT customer_id) AS cnt_uniq_customers
FROM
	retail_sales
GROUP BY 
	category;
--10 Write a SQL query to create each shift and number of orders(e.g Mprning <=12, Afternoon Between 12&17, Evening > 17)
